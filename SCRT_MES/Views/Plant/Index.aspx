...
<body>
            ...
            <ext:GridPanel UI="Primary" ID="GridPanel1" runat="server" ForceFit="true" Region="Center">
                    ...
                    <ext:Toolbar ID="Toolbar1" runat="server" AutoScroll="true">
                        <Items>
                            <ext:FormPanel runat="server" BodyStyle="background-color: #d6e6f2;" Frame="true" ID="seachForm" Layout="HBoxLayout">
                                <Items>
                                   <ext:ComboBox ID="ComboBox1" LabelWidth="60" Width="180" Name="numberCode" runat="server" Editable="false" FieldLabel="Plant" EmptyText="搜索Plant" ValueField="Value" StoreID="store2" DisplayField="Text" PaddingSpec="0 0 0 10">
                                    </ext:ComboBox>
                ...
                <Store>
                    <ext:Store ID="store1" runat="server" AutoLoad="true" PageSize="15" RemoteSort="true" RemoteFilter="true">
                        ...
                        <Proxy>
                            <ext:AjaxProxy Json="true" Url="/Plant/GetTableData/" SimpleSortMode="true">
                                <Reader>
                                    <ext:JsonReader RootProperty="data" TotalProperty="total" ModelName="storeModel"></ext:JsonReader>
                                </Reader>
                            </ext:AjaxProxy>
                ...
                <ColumnModel ID="ColumnModel1" runat="server" EnableColumnHide="false" Flex="2" AnchorHorizontal="100%">
                    <Columns>
                        ...
                        <ext:Column ID="Column2" Align="Center" Width="150" Hidden="false" DataIndex="numberCode" Text="PlantCode" runat="server">
                        </ext:Column>
                    </Columns>
                </ColumnModel>
                <Listeners>
    ...
    <ext:Window runat="server" Title="编辑" Hidden="true" ID="win" Modal="true" Width="270" Height="140">
        <Items>
            <ext:FormPanel PaddingSpec="5 0 0 0" ID="tableDataForm" runat="server" Region="Center" Frame="true" ColumnWidth="1.0" Method="POST">
                <Items>
                    <ext:FieldSet ID="FieldSet2" runat="server" MaxWidth="335" Height="50" ColumnWidth="0.8" Title="编辑信息" MarginSpec="5 8 5 5" ButtonAlign="Right">
                        <Defaults>
                            <ext:Parameter Name="LabelWidth" Value="90" />
                        </Defaults>
                        <Items>
                            <ext:TextField ID="TextField1" Name="id" Hidden="true" runat="server" FieldLabel="编号" />
                            <ext:TextField ID="TextField2" MinWidth="150" EmptyText="请输入Plant" AllowBlank="false" Name="numberCode" runat="server" FieldLabel="Plant" LabelWidth="40">
                            </ext:TextField>
