            ...
            <ext:GridPanel UI="Primary" ID="GridPanel1" runat="server" ForceFit="true" Region="Center">
                    ...
                    <ext:Toolbar ID="Toolbar1" runat="server" AutoScroll="true">
                        <Items>
                            <ext:FormPanel runat="server" BodyStyle="background-color: #d6e6f2;" Frame="true" ID="seachForm" Layout="HBoxLayout">
                                <Items>
                                    <ext:ComboBox ID="ComboBox1" LabelWidth="60" Width="180" Name="beLongToId" runat="server" Editable="false" FieldLabel="Plant" EmptyText="搜索Plant" ValueField="Value" StoreID="store3" DisplayField="Text" PaddingSpec="0 0 0 10">
                                        <Listeners>
                                            <Select Fn="PlantToSelect"></Select>
                                        </Listeners>
                                    </ext:ComboBox>
                                    <ext:ComboBox ID="ComboBox3" LabelWidth="60" Width="180" Name="numberCode" runat="server" Editable="false" FieldLabel="Stock" EmptyText="搜索Stock" ValueField="Value" StoreID="store2" DisplayField="Text" PaddingSpec="0 0 0 10">
                                    </ext:ComboBox>
                ...
                <Store>
                    <ext:Store ID="store1" runat="server" AutoLoad="true" PageSize="15" RemoteSort="true" RemoteFilter="true">
                        ...
                        <Proxy>
                            <ext:AjaxProxy Json="true" Url="/Stock/GetTableData/" SimpleSortMode="true">
                                <Reader>
                                    <ext:JsonReader RootProperty="data" TotalProperty="total" ModelName="storeModel"></ext:JsonReader>
                                </Reader>
                            </ext:AjaxProxy>
                ...
                <ColumnModel ID="ColumnModel1" runat="server" EnableColumnHide="false" Flex="2" AnchorHorizontal="100%">
                    <Columns>
                        ...
                        <ext:Column ID="Column2" Align="Center" Width="150" Hidden="false" DataIndex="numberCode" Text="StockCode" runat="server">
                        </ext:Column>
                ...
                <Items>
                    <ext:FieldSet ID="FieldSet2" runat="server" MaxWidth="335" Height="100" ColumnWidth="0.8" Title="编辑信息" MarginSpec="5 8 5 5" ButtonAlign="Right">
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="TextField2" MinWidth="150" EmptyText="请输入Stock" AllowBlank="false" Name="numberCode" runat="server" FieldLabel="Stock" LabelWidth="40">
                            </ext:TextField>
                            <ext:ComboBox ID="ComboBox2" MinWidth="215" LabelWidth="40" Width="180" Name="beLongToId" AllowBlank="false" runat="server" Editable="false" FieldLabel="Plant" EmptyText="选择Plant" ValueField="Value" StoreID="store3" DisplayField="Text">
                            </ext:ComboBox>
                        </Items>
                    </ext:FieldSet>
                </Items>
        ...
        var EditSaveMethod = function () {
            ...
            App.tableDataForm.submit({
                ...
                failure: function (a, b, c) {
                    Ext.Msg.alert('提示', "操作失败,该Stock已存在");
                }
            });
        }
        /*表格数据的删除方法*/
